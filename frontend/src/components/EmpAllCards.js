...
import { deleteEmp } from "../actions/empAction";

const EmpAllCards = ({ val }) => {
  ...
  const handleClickOpenEmpDialog = () => {
    ...
    <>
      <Card sx={{ maxWidth: 345 }}>
        <AddAdminDialogBox
          ...
          handleCloseEmpDialog={handleCloseEmpDialog}
          val={val}
        />
        <CardHeader
          avatar={
        ...
        <CardHeader
          avatar={
            <Avatar
              sx={{ bgcolor: red[500] }}
              aria-label="recipe"
              src={val.admin[0]?.admin_image}
            ></Avatar>
          }
          title={val.admin[0]?.name}
